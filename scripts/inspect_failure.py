...
def main():
    ...
    try:index=int(args.box_id.removeprefix("SYN-"))
    except ValueError:parser.error("Формат идентификатора: SYN-0023")
    if not 0<=index<10000:parser.error("Индекс должен быть от 0 до 9999")
