...
| Проверка | Результат |
|---|---|
| Физическая модель, четыре этикетки на грань | 10/12 полных множеств; 288/288 истинных значений; 2 ложных |
| Стресс-набор, Code 128 +45° | 47/60 полных множеств; 120/140 значений; 0 ложных |
| CPU replay, 3 отдельных запуска | 36 коробок / 1368 заданий; 24/36 полных множеств |
| Время CPU replay | p95 475,2 мс; p99 477,8 мс; просрочек 0/36 |
| Измерительная машина | Apple M5; 8 рабочих процессов; подготовка массивов включена |
<!-- RESULTS:END -->
